...
?>
<nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top shadow-sm" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%) !important; border: none;">
    <div class="container">
            ...
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" aria-labelledby="moreDropdown">
                        ...
                        <li><a class="dropdown-item" href="/micro-oss/index.php?route=socio"><i class="fas fa-users me-2 text-primary"></i>Socio-Demographic</a></li>
