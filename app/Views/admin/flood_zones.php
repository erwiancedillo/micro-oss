...
<style>
    ...
    .risk-high { background: rgba(255, 0, 0, 0.1); color: red; }
    .risk-moderate { background: rgba(255, 165, 0, 0.1); color: orange; }
    .risk-low { background: rgba(0, 128, 0, 0.1); color: green; }
    .risk-safe { background: rgba(49, 151, 149, 0.1); color: #319795; }
...
function initMap() {
    map = new google.maps.Map(document.getElementById("drawingMap"), {
        center: { lat: 7.028012, lng: 125.447948 }, // Toril Center
        zoom: 14,
        mapTypeId: 'roadmap',
...
function openAdd() {
    ...
    if (!map) initMap();
    else { clearMap(); map.setCenter({ lat: 7.028012, lng: 125.447948 }); map.setZoom(14); }
}
